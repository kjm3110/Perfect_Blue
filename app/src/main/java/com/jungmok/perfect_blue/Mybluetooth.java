...
public class Mybluetooth extends AppCompatActivity implements AdapterView.OnItemClickListener
{
    ...
    public static void getHandler(android.os.Handler handler)
    {
        mHandler = handler;
    }
    static android.os.Handler mHandler = new android.os.Handler();
    static ConnectedThread connectedThread;
    public static final UUID MY_UUID = UUID.fromString("00001101-0000-1000-8000-00805F9B34F8");

    protected static final int SUCCESS_CONNECT=0;
    protected static final int MESSAGE_READ=1;
    ListView listView;
    ArrayAdapter<String> listAdaptor;
    static BluetoothAdapter btAdaptor;
    ...
    private void init()
    {
        ...
        receiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent)
            {
                ...
                {
                    if (btAdaptor.getState() == btAdaptor.STATE_OFF)
                    {
                        turnOnBT();
                    }
                }
